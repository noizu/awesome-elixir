...
* [GenAI](https://github.com/noizu-labs-ml/genai) - An extensible Generative AI Completion API Wrapper with basic chat completion with tools use support for Gemini, Anthropic, OpenAI, and Mistral. 
